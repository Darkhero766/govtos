...
import './first-response-companion.css';
import EvidenceUploadBridge from './evidence-upload-bridge';
import HindiTranslate from './hindi-translate';
import FirstResponseCompanion from '../components/FirstResponseCompanion';
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="en"><body><EvidenceUploadBridge /><HindiTranslate /><FirstResponseCompanion />{children}</body></html>;
}
